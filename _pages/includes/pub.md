...
- Reinforcement Learning-based Streaming Process Discovery under Concept Drift. Cai, C. Zheng, J. Wang, **D. Li**, et al. 36th International Conference on Advanced Information Systems Engineering **<font color=BlueViolet>(CAiSE 2024)</font>** (CCF B) <span style="color:blue; cursor:pointer;" onclick="showAlert('2024RLSPD')">[Bib]</span>, **[[PDF](_pages/paper/2024-RLSPD.pdf)]**
